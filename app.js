  ...
  function clickHandler(e) {
    ...
    if(bdayStr !== '') {
      ...
      if(isPalindrome) {
        ...
        result.innerHTML = `No, your birthday is <span>Not</span> a Palindrome.☹️<br> 
        The next palindrome date is <span>${nextDate.day}-${nextDate.month}-${nextDate.year}, You just missed by <span>${countNext}</span> days</span> 
        <br>
        Also, The Previous palindrome date is <span>${prevDate.day}-${prevDate.month}-${prevDate.year}</span>, you just missed by <span>${countPrev}</span> days.`
